...
export default function(hljs) {
  ...
  var VERBATIM_STRING = {
    className: 'string',
    begin: '@"', end: '"',
    contains: [ESCAPE_STRINGS, {begin: '""'}]
  };
  var VERBATIM_STRING_NO_LF = hljs.inherit(VERBATIM_STRING, {illegal: /\n/, contains: [ESCAPE_STRINGS]});
  var SUBST = {
    className: 'subst',
    begin: '{', end: '}',
    keywords: KEYWORDS
  ...
  var INTERPOLATED_STRING = {
    ...
    begin: /\$"/, end: '"',
    illegal: /\n/,
    contains: [ESCAPE_STRINGS, {begin: '{{'}, {begin: '}}'}, hljs.BACKSLASH_ESCAPE, SUBST_NO_LF]
  };
  var INTERPOLATED_VERBATIM_STRING = {
    className: 'string',
    begin: /\$@"/, end: '"',
    contains: [ESCAPE_STRINGS, {begin: '{{'}, {begin: '}}'}, {begin: '""'}, SUBST]
  };
  var INTERPOLATED_VERBATIM_STRING_NO_LF = hljs.inherit(INTERPOLATED_VERBATIM_STRING, {
    illegal: /\n/,
    contains: [ESCAPE_STRINGS, {begin: '{{'}, {begin: '}}'}, {begin: '""'}, SUBST_NO_LF]
  });
  SUBST.contains = [
