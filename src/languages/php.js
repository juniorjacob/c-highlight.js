...
export default function(hljs) {
  ...
  var STRING = {
    ...
    variants: [
      ...
      hljs.inherit(hljs.APOS_STRING_MODE, {illegal: null, contains: [ESCAPE_STRINGS]}),
      hljs.inherit(hljs.QUOTE_STRING_MODE, {illegal: null, contains: [ESCAPE_STRINGS]})
    ]
  };
